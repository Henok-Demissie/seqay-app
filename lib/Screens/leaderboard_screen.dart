...
class _LeaderboardScreenState extends State<LeaderboardScreen> {
  ...
  String _getMotivationalMessage() {
    if (_userRank <= 3)
      return "Incredible work! Keep defending your position! 🏆";
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          const Color.fromARGB(255, 9, 167, 4)!,
                          const Color.fromARGB(255, 3, 243, 55)!
                        ],
                      ),
          ...
          children: [
            ...
            if (rank <= 10) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 248, 170, 1),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: const Text(
                  'TOP 10',

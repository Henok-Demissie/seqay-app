...
class _MockExamScreenState extends State<MockExamScreen> {
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  ...
                  color:
                      question.isMarkedForReview ? Colors.orange : Colors.grey,
                ),
                onPressed: () {
                  setState(() {
  ...
  Widget _buildOptionCard(
      Question question, int optionIndex, String optionText) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildResultsStat(
                'Questions Skipped', totalQuestions - answeredQuestions),
            const SizedBox(height: 24),
            SizedBox(
